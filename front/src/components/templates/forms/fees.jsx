...
import FormularioDinamico from '../../general/generalForm';
import { estados } from '../../../models/utils';
import { useState } from 'react';
import { createFeesContract } from '../../../services/contracts';
import RenderPdf from '../contracts/renderPdf';
  ...
  const secoes = [
    ...
    },
    {
      ...
      campos: [
        ...
        ['Estado Civil', 'estado_civil', 'select', 'requerido', ['12', '6', '6', '6'], ['Solteiro(a)', 'Casado(a)', 'Divorciado(a)', 'Viúvo(a)', 'Separado(a)', 'União Estável']],
    ...
    <>
      {!pdfBase64 && (
        <FormularioDinamico
          ...
          onSubmit={(data) => createFeesContract(data)}
          onResult={(resposta) => {
      ...
      {pdfBase64 && (
        <div className="mt-5">
          ...
          <RenderPdf base64Pdf={pdfBase64} nomeArquivo={nomePdf} />
        </div>
      )}
    </>
  );
